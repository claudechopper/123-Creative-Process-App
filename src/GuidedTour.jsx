...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Click "← Save & Back to Drafts" to save your work-in-progress and return to the All Drafts/Incubation page. You can come back and keep sharpening anytime.',
    action: 'Click "← Save & Back to Drafts" to try it, or click Next.',
    waitFor: 'leaveRefine',
    page: 'refine',
