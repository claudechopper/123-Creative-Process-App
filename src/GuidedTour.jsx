...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Click "← Save & Back to Drafts" to save your progress and return to the Drafts/Stop page. Your work is saved — you can come back and keep sharpening anytime.',
    action: 'Click Next to see how to finish a piece.',
    waitFor: 'next',
    page: 'refine',
  ...
  {
    title: 'Finish & Polish',
    body: 'When your edit is truly done, click "Finish & Save ✓" — this moves your piece to the ✭ Polished page, where all your completed work lives.',
    action: 'Click "Finish & Save" to see the Polished page, or click Next.',
    waitFor: 'leaveRefine',
    page: 'refine',
    highlightText: ['Finish & Save'],
  },
  {
    title: '✭ The Polished Page',
